...
class CarController {
    ...
    CollectionModel<EntityModel<Car>> list() {
        ...
        return CollectionModel.of(resources, link);
    }
    ...
    ResponseEntity<?> post(@Valid @RequestBody Car car) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI(resource.getRequiredLink("cars").expand(resource.getContent().getId()).getHref())).body(resource);
    }
